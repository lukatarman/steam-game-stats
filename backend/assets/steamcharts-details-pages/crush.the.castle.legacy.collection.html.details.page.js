export const crushTheCastleHtmlDetailsSteamcharts = `<!DOCTYPE html>
<html lang="en">
<head>

<meta charset="utf-8">
<title>Crush the Castle Legacy Collection - Steam Charts</title>
...
<meta name="twitter:site" content="@steamcharts"><meta name="twitter:title" content="Crush the Castle Legacy Collection - Steam Charts"><meta name="twitter:url" content="http://steamcharts.com/app/1838970">
...
<div id="content-wrapper">
	...
	<h1 id="app-title"><a href="">Crush the Castle Legacy Collection</a></h1>
<div id="app-links">
	<a href="http://store.steampowered.com/app/1838970/">Store</a>
	|
	<a href="http://steamcommunity.com/app/1838970">Hub</a>
</div>
<div id="app-heading" class="content">
	<img class="app-image"
		src="/assets/steam-images/1838970.jpg"
		alt="Crush the Castle Legacy Collection"
		width="184" height="69">
	<div class="app-stat">
		<span class="num">0</span>
		<br>playing <abbr class="timeago" title="2022-06-07T13:24:08Z"></abbr>
	</div>
	<div class="app-stat">
...
<div id="app-hours-content" class="content">
	...
	<div style="float: right; margin: 0; padding: 0">
		<a href="/cmp/1838970">Compare with others...</a>
	</div>
</div>
<div class="ad720">
	<div id="nn_lb1"></div>
	...
	<table class="common-table">
		...
		<tbody>
			<tr class="odd">
				...
				<td class="right num-f italic">2.60</td>
				<td class="right num-p gainorloss italic">-0.4</td>
				<td class="right gainorloss italic">-11.92%</td>
				<td class="right num italic">10</td>
			</tr>
			...
			<tr >
				...
				<td class="right num-f">2.96</td>
				<td class="right num-p gainorloss">-4.59</td>
				<td class="right gainorloss">-60.84%</td>
				<td class="right num">10</td>
			</tr>
...
<script>
	...
	$.getJSON('/app/1838970/chart-data.json', function(data) {
		app.gameChart('app-longterm-chart', ["Crush the Castle Legacy Collection"], [data]);
	});
</script>
