export const sniperEliteHttpDetailsSteamcharts = `
<!DOCTYPE html>
<html lang="en">
<head>

<meta charset="utf-8">
<title>Sniper Elite 5 - Steam Charts</title>
...
<meta name="twitter:site" content="@steamcharts"><meta name="twitter:title" content="Sniper Elite 5 - Steam Charts"><meta name="twitter:url" content="http://steamcharts.com/app/1029690">
...
<div id="content-wrapper">
	...
	<h1 id="app-title"><a href="">Sniper Elite 5</a></h1>
<div id="app-links">
	<a href="http://store.steampowered.com/app/1029690/">Store</a>
	|
	<a href="http://steamcommunity.com/app/1029690">Hub</a>
</div>
<div id="app-heading" class="content">
	<img class="app-image"
		src="/assets/steam-images/1029690.jpg"
		alt="Sniper Elite 5"
		width="184" height="69">
	<div class="app-stat"> 
		<span class="num">8351</span>
		<br>playing <abbr class="timeago" title="2022-05-28T07:00:37Z"></abbr>
	</div>
	<div class="app-stat"> 
		<span class="num">8351</span>
		<br>24-hour peak
...
<div id="app-hours-content" class="content">
	...
	<div style="float: right; margin: 0; padding: 0">
		<a href="/cmp/1029690">Compare with others...</a>
	</div>
</div>
<div class="ad720">
	<div id="nn_lb1"></div>
	...
	<table class="common-table">
		...
		<tbody>
			<tr class="odd">
				...
				<td class="right num-f italic">7744.12</td>
				<td class="right num-p gainorloss italic"></td>
				<td class="right gainorloss italic"></td>
				<td class="right num italic">8351</td>
			</tr>
...
<script>
	...
	$.getJSON('/app/1029690/chart-data.json', function(data) {
		app.gameChart('app-longterm-chart', ["Sniper Elite 5"], [data]);
	});
</script>
