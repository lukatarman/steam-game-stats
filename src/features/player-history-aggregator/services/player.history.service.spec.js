...
describe("player.history.service.js", function () {
  describe(".addCurrentPlayersFromSteam adds the current players to the games object and calculates the average players. So,", function () {
    ...
    fdescribe("when the game's 'playerHistory' array includes this month's entry", function () {
      beforeEach(function () {
        this.playersFromSteam = ["32"];
      ...
      it("'this.results[0].playerHistory[0]' is an instance of Players", function () {
        expect(this.result[0].playerHistory[0]).toBeInstanceOf(Players);
      });
      it("'this.result[0].playerHistory[0]' has a property called 'average players', which equals '40.3'", function () {
        expect(this.result[0].playerHistory[0].averagePlayers).toBe(40.3);
      });
      it("'this.result[0].playerHistory[0].trackedPlayers[0]' is an instance of 'TrackedPlayers'", function () {
        expect(this.result[0].playerHistory[0].trackedPlayers[0]).toBeInstanceOf(
          TrackedPlayers,
        );
      });
    ...
    describe("when the game's 'playerHistory' array is not empty, and it does not include this month's entry", function () {
      beforeEach(function () {
        this.playersFromSteam = ["32"];
      ...
      it("'this.results[0].playerHistory[0]' has a property called 'average players', which equals '0'", function () {
        expect(this.result[0].playerHistory[0].averagePlayers).toBe(0);
      });
      it("'this.results[0].playerHistory[0]' has a property called 'tracked players' its first array entry is an instance of 'TrackedPlayers'", function () {
        expect(this.result[0].playerHistory[0].trackedPlayers[0]).toBeInstanceOf(
          TrackedPlayers,
        );
      });
      it("'this.results[0].playerHistory[1]' is an instance of Players", function () {
  ...
  describe(".addPlayerHistoriesFromSteamcharts uses the gamesPagesMap to add the player histories to each entry in the games array, and then returns it. So,", function () {
    describe("if the gamesPagesMap includes Elden Ring's player history", function () {
      ...
      it("'this.result[0].playerHistory[0]' is an instance of 'Players'", function () {
        expect(this.result[0].playerHistory[0]).toBeInstanceOf(Players);
      });
      it("'this.result[0].playerHistory[0]' has a property called 'year', which equals '2022'", function () {
        expect(this.result[0].playerHistory[0].year).toBe(2022);
      });
      it("'this.result[0].playerHistory[0]' has a property called 'month', which equals '2'", function () {
        expect(this.result[0].playerHistory[0].month).toBe(2);
      });
      it("'this.result[0].playerHistory[0]' has a property called 'averagePlayers', which equals '522066.4'", function () {
        expect(this.result[0].playerHistory[0].averagePlayers).toBe(522066.4);
      });
      it("'this.result[0].playerHistory[1]' has a property called month, which equals '3'", function () {
        expect(this.result[0].playerHistory[1].month).toBe(3);
      });
      it("'this.result[0].playerHistory[1]' has a property called averagePlayers, which equals '211468.9'", function () {
